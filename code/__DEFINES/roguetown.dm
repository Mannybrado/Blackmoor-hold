...
#define RACES_TOLERATED_UP_DIVINE list(RACES_TOLERATED, RACES_RESPECTED, RACES_DIVINE)
...
#define RACES_NO_CONSTRUCT list(RACES_DESPISED, RACES_SHUNNED, RACES_TOLERATED, RACES_RESPECTED, RACES_DIVINE)
